...
public class CalculatePlayerScoreStepDefinitions {
	...
	public void the_game_has_bonus_option(String bonus) {
		if (bonus.equals("Harmony")) {
			BonusOption HarmonyOption = new BonusOption("Harmony", kingdomino);
			Game game = KingdominoApplication.getKingdomino().getCurrentGame();
			game.addSelectedBonusOption(HarmonyOption);
		} else if (bonus.contentEquals("Middle Kingdom")) {
	...
	public void the_total_score_should_be(int playerscore) {
		Game game = KingdominoApplication.getKingdomino().getCurrentGame();
		assertEquals(playerscore, game.getPlayer(0).getTotalScore());
	}
