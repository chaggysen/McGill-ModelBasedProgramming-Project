 ...
 *
 */
public class VerifyKingdomGridSizeStepDefinitions {
	
	private String check = "invalid";
	private boolean checktf = false;
	private int totalx, totaly = 1;
	private DominoInKingdom thisdomino;
	...
	public void validation_of_the_grid_size_is_initiated() {
		...
		checktf = KingdominoController.verifyKingdomGridSize(kingdom);
	}
